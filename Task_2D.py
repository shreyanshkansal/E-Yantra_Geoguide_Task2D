...
# Team ID:			eYRC#GG#3352
# Author List:		Shreyansh Kansal
# Filename:			Task_2D.py
...
def read_csv(csv_name):
    ...
    with open(csv_name, mode ='r') as file:
        ...
        for lines in csvFile:
            if lines[1]=="lat":
                lat_lon[lines[0]]=[lines[1], lines[2]]
            else:
                lat_lon[float(lines[0])]=[float(lines[1]), float(lines[2])]
